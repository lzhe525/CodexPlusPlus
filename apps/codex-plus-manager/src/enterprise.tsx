...
import { CheckCircle2, CircleX, LogOut, RefreshCw, ShieldCheck } from "lucide-react";

export type EnterpriseSnapshot = {
  enabled: boolean;
  state: "disabled" | "unauthenticated" | "authenticating" | "authenticated" | "expired" | "error" | string;
